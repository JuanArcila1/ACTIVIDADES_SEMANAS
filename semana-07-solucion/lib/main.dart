...
class App extends StatelessWidget{const App({super.key});@override Widget build(BuildContext context)=>MaterialApp(debugShowCheckedModeBanner:false,title:'Importaciones — Semana 07',theme:ThemeData(useMaterial3:true),home:const Home());}
